(self.webpackChunkfan_control = self.webpackChunkfan_control || []).push([
  [406],
  {
    9940: function (e, r, t) {
      ...
      function L(e) {
        return !Number.isNaN(Number(e)) || w.has(e) || y.test(e) || M(e);
      }
      function M(e) {
        var r,
      ...
      function P() {
        ...
        return {
          ...
          classGroups: {
            ...
            "col-start-end": [{ col: ["auto", { span: [j] }] }],
            "col-start": [{ "col-start": S() }],
            "col-end": [{ "col-end": S() }],
            "grid-rows": [{ "grid-rows": [Z] }],
            "row-start-end": [{ row: ["auto", { span: [j] }] }],
            ...
            contrast: [{ contrast: [s] }],
            "drop-shadow": [{ "drop-shadow": ["", "none", R, z] }],
    ...
    408: function (e, r, t) {
      ...
      e.exports = function (e, r, t) {
        ...
        if (L) g = e.iterator;
          ...
          if (i(v)) {
            for (h = 0, x = s(e); x > h; h++)
              if ((y = N(e[h])) && c(m, y)) return y;
            return new b(!1);
          }
          g = u(e, v);
        }
        for (w = L ? e.next : g.next; !(C = n(w, g)).done; ) {
          try {
            y = N(C.value);
          } catch (j) {
            f(g, "throw", j);
      ...
      var o = t(7294),
        ...
        c = function () {
          return o.createElement(
            ...
            {
              className:
                "border border-t bg-slate-100 border-slate-300 flex min-h-sm text-slate-500 pt-2 mt-10 text-center",
            },
            o.createElement(
              "div",
              ...
              o.createElement(
                "div",
                {
                  className: "flex space-x-3 py-3 items-center justify-center",
                },
                o.createElement(s, {
                  iconSvgPath: n.Z.svgPaths.heart,
                  href: a.Z.urls.sponsor,
                  text: "Sponsor",
                }),
                o.createElement(s, {
                  iconSvgPath: n.Z.svgPaths.paypal,
                  href: a.Z.urls.donationUrl,
                  viewBox: "0 0 16 16",
                  text: "PayPal",
                })
              )
            ...
            o.createElement(
              ...
              o.createElement(
                "svg",
                {
                  ...
                  className:
                    (l ? "animate-spin" : "") + " hover:animate-spin h-10 w-10",
                  viewBox: "0 0 24 24",
                },
                o.createElement("path", {
                  fill: "currentColor",
              ...
              o.createElement(
                "div",
                { className: "ml-2" },
                o.createElement(u.Link, { to: f[0].url }, "Fan Control"),
                " ",
                (r = t) ? "> " + r : ""
              )
            ),
            o.createElement(
              ...
              f.map(function (e) {
                return o.createElement(
                  ...
                  o.createElement(u.Link, { to: e.url }, e.title)
                );
              })
            )
          );
        ...
        b = function (e) {
          ...
          return o.createElement(
            ...
            o.createElement(p, { pageTitle: r }),
            o.createElement("main", { className: "bg-transparent grow" }, t),
...
//# sourceMappingURL=0b5ad58107c2a363dd57b3503c89da61e0a7a842-5c532d9c55ab1c87021d.js.map
