      ...
      var i = function (t, e) {
        ...
        f = function (t, e) {
          var n,
            ...
            f = function (t) {
              t.hadRecentInput ||
                ((u.value += t.value), u.entries.push(t), n());
            },
            s = a("layout-shift", f);
          s &&
            ((n = c(t, u, e)),
            r(function () {
              s.takeRecords().map(f), n();
            }),
            o(function () {
              (u = i("CLS", 0)), (n = c(t, u, e));
            }));
        ...
        m = function () {
          return (
            s < 0 &&
              ((s = self.webVitals.firstHiddenTime) === 1 / 0 && d(),
              o(function () {
                setTimeout(function () {
                  (s = "hidden" === document.visibilityState ? 0 : 1 / 0), d();
                }, 0);
              })),
            {
              get timeStamp() {
            ...
            s = function (t) {
              "first-contentful-paint" === t.name &&
                ...
                t.startTime < r.timeStamp &&
                  ((f.value = t.startTime), f.entries.push(t), u.add(f), n()));
            },
        ...
        p = function (t, e) {
          var n,
            ...
            d = function (t) {
              var e = t.startTime;
              e < f.timeStamp && ((s.value = e), s.entries.push(t)), n();
            },
          ...
          if (v) {
            ...
            var l = function () {
              u.has(s) ||
                (v.takeRecords().map(d), v.disconnect(), u.add(s), n());
            };
            ["keydown", "click"].forEach(function (t) {
              addEventListener(t, l, { once: !0, capture: !0 });
            }),
              r(l, !0),
              o(function (a) {
                (s = i("LCP")),
                  ...
                  requestAnimationFrame(function () {
                    requestAnimationFrame(function () {
                      (s.value = performance.now() - a.timeStamp),
                        u.add(s),
                        n();
                    });
                  });
...
//# sourceMappingURL=589-bb859a44ef0f0efba8f8.js.map
